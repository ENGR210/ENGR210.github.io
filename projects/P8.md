# Project 7: Elevator Control

## <span style="color:red">Due: Friday April 15th</span>
...
![sevSegDisplay Overview](assets/P7/P7_1.png)
...
![flr3 door open](assets/P7/P7_2.png)

The next diagram shows the **door closed** but still on **floor 3**.

![flr3 door closed](assets/P7/P7_3.png)
...
![elvtr transit diag](assets/P7/P7_4.png)
